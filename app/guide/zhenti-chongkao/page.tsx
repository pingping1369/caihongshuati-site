...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "建议倒序：先把最近三年（2023-2025）刷透——它们与下一次考试的考点重合度最高；再往前扩展到 2020-2022；更早年份用于查漏补缺。做错的题不要只对答案，顺着题目挂载的考点把整块知识补掉，效率最高。",
      },
    },
  ],
};
  ...
  return (
    <main className="sec wrap article" style={{ margin: "0 auto" }}>
      ...
      <div className="card">
        ...
        <ul>
          <li>
            <strong>倒序刷：近三年优先。</strong>2023-2025 的题与下次考试的考点重合度最高，先刷透，
            再往前扩到 2020-2022，更早年份查漏补缺。
          </li>
          <li>
            <strong>错题要连考点一起补。</strong>做错一道，说明这个考点没掌握——而它有八成概率还会再考。
            只对答案是把最值钱的信号扔掉了。
          </li>
          <li>
