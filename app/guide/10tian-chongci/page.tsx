...
export const metadata: Metadata = {
  ...
  description:
    "考前只剩 10 天的务实方案：先说清 10 天能做到什么、该放弃什么，再给一天一步的冲刺表。全部取舍基于 1735 道真题的统计：近三年 80.9% 的题考老考点、46 个核心考点覆盖 26% 的题。",
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "从零开始来不及——这门考试知识面宽、医学味重，10 天学不完一轮。但如果此前看过书或有专业底子，10 天足够把「可预测的分」拿稳：按 2017-2025 真题统计，近三年 80.9% 的题考的是往年考过的考点，46 个年年考的核心考点覆盖了近三年 26% 的题。冲刺的正确目标不是学完，而是把这部分高确定性的分守住。",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "不用刷完九年。10 天优先近三年（2023-2025，共约 590 题）：它们与下次考试的考点重合度最高。刷的方式比数量重要——每道错题都要点开对应考点把整块知识补掉，而不是只对答案。有余力再往前扩 2021-2022，更早年份放弃也不可惜。",
      },
    },
    {
      "@type": "Question",
      ...
      <div className="card">
        ...
        <div className="bignum-row">
          <div className="bignum">
            <b>80.9%</b>
            <span>近三年真题中，考点在往年考过的比例——考什么高度可预测</span>
          </div>
          <div className="bignum">
            <b>26%</b>
        ...
        <p>
          命题围绕一个相对固定的核心考点池反复出题（逐年数据见
          <Link href="/guide/zhenti-chongkao">《真题重考率》</Link>）。
          冲刺的全部策略就一句话：<strong>放弃「学完」，专攻这个池子</strong>。
        </p>
        ...
        <ul>
          <li>
            <strong>错题必须连考点一起补。</strong>做错说明这个考点没掌握，而它有八成概率还会再考。
